...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "aleksander-bujnowski": "bujnowski.aleksander@gmail.com",<br/>  "bartlomiej-krajewski": "bartekworms3@gmail.com",<br/>  "krzysztof-kluczynski": "krzysztof.kluczynski22@gmail.com",<br/>  "marek-wiewiorka": "marek.wiewiorka@gmail.com"<br/>}</pre> | no |
